...
$pageSpecificJS = [
    ...
    'inventory' => ['inventory.js', 'inventory-stock-import.js', 'inventory-entries.js'],
    'users' => 'users.js',
    ...
    'orders' => ['orders.js', 'orders_awb.js', 'orders_awb_tracking.js'],
    'sellers' => ['sellers.js', 'sellers-import.js'],
    'purchase_orders' => 'purchase_orders.js',
    'product-units' => ['barcode_generator.js', 'product-units.js'],
